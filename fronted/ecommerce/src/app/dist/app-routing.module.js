...
exports.routes = [
    ...
    {
        path: 'auth',
        loadChildren: function () { return Promise.resolve().then(function () { return require('./modules/auth-profile/auth-profile.module'); }).then(function (m) { return m.AuthProfileModule; }); }
    },
    {
        path: '',
        redirectTo: '/',
